...
let users = [
  {
    ...
    name: "Hamim Tohari",
    idNumber: "20210123",
    email: "20210123.Hamim@dosen.polibatam.ac.id",
    role: "Dosen",
  },
  {
    id: genId(),
    name: "Yohan",
    idNumber: "3312501050",
    email: "3312501050.Yohan@students.polibatam.ac.id",
    role: "Mahasiswa",
  },
  {
    id: genId(),
    name: "Hanes",
    idNumber: "3312501023",
    email: "3312501023.Hanes@students.polibatam.ac.id",
    role: "Admin",
  },
  {
    id: genId(),
    name: "Blacky",
    idNumber: "3312501045",
    email: "3312501045.Blacky@students.polibatam.ac.id",
    role: "Mahasiswa",
  },
  {
    id: genId(),
    name: "Hasbiya Abrar",
    idNumber: "3310501035",
    email: "3310501035.Hasbi@students.polibatam.ac.id",
    role: "Mahasiswa",
  },
  {
    id: genId(),
    name: "Wicaksono",
    idNumber: "20210102",
    email: "20210102.Wicak@dosen.polibatam.ac.id",
    role: "Dosen",
  },
  {
    id: genId(),
    name: "Nugroho",
    idNumber: "20210106",
    email: "20210106.Nugroho1234@dosen.polibatam.ac.id",
    role: "Dosen",
  },
];
...
let avatars = {};
try {
  avatars = JSON.parse(localStorage.getItem("users_avatars") || "{}");
} catch (e) {
  avatars = {};
}
...
function renderRows(filter = "") {
  ...
  const list = users.filter((u) => {
    if (!q) return true;
    return [u.name, u.idNumber, u.email, u.role]
      .join(" ")
      .toLowerCase()
      .includes(q);
  });
