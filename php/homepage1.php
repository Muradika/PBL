<?php
include '../database/pengumuman.php'; // Pastikan db_connection.php sudah mengarah ke database 'sipak'

// --- 1. SETUP PARAMETER DEFAULT ---
$announcements_per_page = 6; // Hanya 6 card per halaman
...
// --- 2. KONSTRUKSI QUERY (Filter & Search) ---
$where_clauses = [];
$bind_params = '';
$bind_values = [];
...
if (!empty($filter_type)) {
    // Jika ada search_query, type sudah terfilter di atas. Jika tidak, tambahkan filter spesifik.
...
// --- 3. MENGHITUNG TOTAL PENGUMUMAN (UNTUK PAGINATION) ---
...
// --- 4. MENGAMBIL DATA PENGUMUMAN UNTUK HALAMAN SAAT INI ---
...
// Helper function untuk mempertahankan parameter URL saat berpindah halaman
function get_url_params($page_num)
{
    $params = $_GET;
    $params['page'] = $page_num;
    // Hapus parameter filter jika tidak ada nilainya
            ...
            <div class="filter-dropdown-container">
                ...
                <div id="filterOptions" class="filter-options">
                    ...
                    foreach ($categories as $cat):
                        // Catatan: Pastikan nilai ini sesuai dengan value yang di-input dosen di profiledosen.php
                        $link_params = $_GET;
                        $link_params['filter'] = $cat;
                        unset($link_params['page']); // Reset ke halaman 1 saat filter
        ...
        <div class="card-grid">
            <?php if (!empty($announcements)): ?>
                <?php foreach ($announcements as $announcement): ?>
                    <?php
                    // Menentukan URL dokumen, jika kosong arahkan ke '#'
                    $doc_url = $announcement['document_path'] ?: '#';
                    // Menentukan path gambar, jika kosong gunakan placeholder
                    $img_url = $announcement['image_path'] ?: 'https://via.placeholder.com/300x180?text=' . urlencode($announcement['type']);
                    ?>

                    <div class="announcement-card" data-category="<?php echo htmlspecialchars($announcement['type']); ?>"
