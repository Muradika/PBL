...
<body>
  ...
  <main class="container">
    <div class="card-grid">
      ...
      <div class="announcement-card" data-category="Karir" data-date="2025-11-05"
        data-title="Pendaftaran Program Magang Industri Semester Pendek"><a href="https://rene.citratubindo.com/"
  ...
  <div class="pagination">
    ...
    <a href="homepage2.php" class="page-number">2</a>
    <a href="homepage3.php" class="page-number active">3</a>
    ...
    <div class="footer-content">
      ...
      <div class="footer-right">
        ...
        <div class="social-links">
          <a href="https://www.instagram.com/polibatamofficial?igsh=dDdmeGVwbzVhbmR3" class="social-btn instagram">
